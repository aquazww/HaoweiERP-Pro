<template>
  <div class="common-page stock-out-page">
...
<style scoped>
.stock-out-page .detail-dialog .order-detail { padding: 10px 0; }
.stock-out-page .detail-header { margin-bottom: 15px; }
.stock-out-page .detail-header h3 { margin: 0 0 10px 0; font-size: 16px; color: var(--color-text-primary); font-weight: 600; }
.stock-out-page .info-row { display: flex; margin-bottom: 12px; }
.stock-out-page .info-item { flex: 1; display: flex; align-items: center; gap: 8px; }
.stock-out-page .info-item .label { font-weight: 600; color: var(--color-text-secondary); min-width: 80px; }
.stock-out-page .info-item .value { color: var(--color-text-primary); font-weight: 500; }
.stock-out-page .detail-items { margin-top: 20px; }
.stock-out-page .detail-items h4 { margin-bottom: 12px; font-size: 15px; color: var(--color-text-primary); font-weight: 600; }
</style>
