<template>
  <div class="common-page inventory-page">
...
<style scoped>
.inventory-page .quantity-out { color: var(--color-danger); font-weight: 600; }
.inventory-page .quantity-low { color: var(--color-warning); font-weight: 600; }
.inventory-page .quantity-over { color: var(--color-primary); font-weight: 600; }
.inventory-page .text-success { color: var(--color-success); }
.inventory-page .text-danger { color: var(--color-danger); }
.inventory-page .log-dialog .log-header {
  display: flex; gap: 24px; margin-bottom: 16px; padding: 12px 16px;
  background: var(--color-bg-light); border-radius: var(--border-radius-md);
  font-size: 14px; color: var(--color-text-secondary);
  border: 1px solid var(--color-border-light);
}
.inventory-page .warning-dialog .warning-empty { padding: 24px; }
</style>
